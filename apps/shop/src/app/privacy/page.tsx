    ...
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="space-y-8 text-slate-400 leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-4">
            We do not have access to or control over the tracking data collected by third-party vendors. Our current affiliate partners include Limitless Life Nootropics, Swiss Chems, GLP-1 Research Lab, and Apollo Peptide Sciences. We encourage you to review the privacy policies of any vendor site you visit.
          </p>
        </section>
