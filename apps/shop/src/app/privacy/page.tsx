    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="space-y-8 text-[color:var(--ink-soft)] leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-4">
            We do not have access to or control over the tracking data collected by third-party vendors. We encourage you to review the privacy policies of any vendor site you visit.
          </p>
        </section>
