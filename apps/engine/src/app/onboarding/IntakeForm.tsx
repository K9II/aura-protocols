...
export default function IntakeForm({ initial, hasData }: { initial?: IntakeState; hasData?: boolean }) {
  ...
  const btnNext = "flex-1 p-btn-primary px-4 py-3 text-sm font-bold disabled:opacity-50 disabled:cursor-not-allowed";
  ...
  return (
    <div>
      ...
      {error && <p className="mb-4 text-sm text-[color:var(--specimen)]">{error}</p>}
      ...
      {step === 1 && (
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <button
              className="w-full border border-[color:var(--specimen)] bg-[color:var(--sig-alert-tint)] px-6 py-4 text-left transition hover:bg-[color:var(--paper-deep)] disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="border-t border-[color:var(--line)] pt-4 text-center">
            <a href={SHOP_URL} className="text-xs text-[color:var(--ink-faint)] underline underline-offset-2 transition hover:text-[color:var(--specimen)]">
      ...
      {step === 3 && (
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <label htmlFor="using_peptides" className="text-sm text-[color:var(--ink-soft)]">Currently using peptides</label>
          </div>
            ...
            <div className="flex gap-3">
              {([{ v: true, l: "Yes, show me Rx options" }, { v: false, l: "No, research-grade only" }] as const).map(({ v, l }) => (
                <button
                  ...
                  className={`flex-1 border px-4 py-3 text-sm font-medium transition ${step3.interested_in_rx === v ? "border-[color:var(--specimen)] bg-[color:var(--sig-alert-tint)] text-[color:var(--specimen)]" : "border-[color:var(--line)] bg-[color:var(--paper)] text-[color:var(--ink-soft)] hover:bg-[color:var(--paper-deep)]"}`}
                >
                  {l}
                </button>
              ))}
